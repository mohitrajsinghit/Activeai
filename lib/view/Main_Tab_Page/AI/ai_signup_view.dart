...
class AiSignupView extends StatefulWidget {
  const AiSignupView({Key? key});

  @override
  State<AiSignupView> createState() => _AiSignupViewState();
}

class _AiSignupViewState extends State<AiSignupView> {
  late Size media;
